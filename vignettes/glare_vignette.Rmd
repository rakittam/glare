...
\end{aligned}
\begin{aligned}
G &= 0.4X_1 + 0.6X_2 + 0.4H - 0.8A_1\\
G^\text{pert} &= 0.4X_1^\text{pert} + 0.6X_2^\text{pert} + 0.4H + 0.8A_1
\end{aligned}
$$
...
estimation, an analogy to partialling out the effect of the anchors A and
