...
while letting the rest the same as in the initial data. To see the changes
compared to the original undisturbed data set, we write down again the formulas
from above that change.
$$
\begin{aligned}
